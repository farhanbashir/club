...
<section class="content">
    <div class="row  col-xs-12">
        <div class="col-xs-6">
            ...
            <a href="<?php echo site_url('admin/courses/delete/' . $course['content_id']) ?>"><button class="btn btn-danger pull-right delete_anything" style="margin:10px ">Delete</button></a>
