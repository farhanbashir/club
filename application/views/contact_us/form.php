<!-- Main content -->
<script src="http://maps.googleapis.com/maps/api/js?v=3&amp;sensor=false&amp;key=AIzaSyC73JVZ4SmwsyuJwJebTvtcQz2DC7L3F-0&amp;callback=loadmap" defer></script>
<?php 
$data_map = unserialize($page['data']);
?>
<script>
    function loadmap() {
        var h_lat = <?php echo!empty($data_map['latitude']) ? $data_map['latitude'] : 24.861577; ?>;
        var h_lng = <?php echo!empty($data_map['longitude']) ? $data_map['longitude'] : -292.990039; ?>;
        // initialize map
        var map = new google.maps.Map(document.getElementById("map-canvas"), {
            center: new google.maps.LatLng(h_lat, h_lng),
            zoom: 13,
        ...
        google.maps.event.addListener(map, "idle", function () {
            ...
            document.getElementById("club_lat").value = map.getCenter().lat().toFixed(6);
            document.getElementById("club_lng").value = map.getCenter().lng().toFixed(6);
                        ...
                        <div class="box box-primary">
                            ...
                            <form name="club_page" id="club_page" action="<?php echo base_url(); ?>index.php/admin/page/update" method="POST"  enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                    ...
                                    <input type="hidden" name="page[data][longitude]" id="club_lng">
                                    <input type="hidden" name="page[data][latitude]" id="club_lat">
