                    ...
                    <table class="table table-hover">
                        ...
                        foreach ($events as $event) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url(); ?>index.php/event/view/<?php echo $event['content_id']; ?>">View</a>
                                    &nbsp;&nbsp;&nbsp;
                                    <a href="<?php echo base_url(); ?>index.php/event/edit/<?php echo $event['content_id']; ?>">Edit</a>
                                    &nbsp;&nbsp;&nbsp;
                                    <a href="<?php echo base_url(); ?>index.php/event/delete/<?php echo $event['content_id']; ?>">Delete</a>
                                </td> 
                            </tr>
                            <?php
                        }
