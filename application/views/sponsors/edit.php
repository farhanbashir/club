...
<section class="content">
    ...
    <div class="row">
        <div class="col-xs-12">
            <p class="lead">Sponsor # <?php echo ucfirst($sponsor['content_id']); ?></p>
                ...
                <div class="col-xs-6">
                    <div class="table-responsive">
                        ...
                        <div class="box box-primary">
                            ...
                            <!-- form start -->
                            <form name="edit_sponsor" id="club_sponsor" action="<?php echo base_url(); ?>index.php/admin/sponsors/update" method="POST"  enctype="multipart/form-data">
                                <input name="sponsor[is_submit]" id="is_submit" value="1" type="hidden" />
                                <input name="sponsor[id]" id="uniqid" value="<?php echo $sponsor['content_id']; ?>" type="hidden" />
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label>Title</label>
                                        <input type="text" class="form-control" name="sponsor[title]" placeholder="Enter ..." value="<?php echo $sponsor['title']; ?>">
                                    </div>
                                            ...
                                            <div class="jFiler-item-inner">                                    
                                                ...
                                                <div class="jFiler-item-assets jFiler-row">         
                                                    ...
                                                    <ul class="list-inline pull-right">   
                                                        <li><a href="<?php echo base_url(); ?>index.php/admin/sponsors/delete_image/<?php echo $image['id'] . '/' . $sponsor['content_id']; ?>" class="icon-jfi-trash jFiler-item-trash-action delete_anything"></a>
                                                        </li>                                       
                                                    </ul>                                
                                                </div>
