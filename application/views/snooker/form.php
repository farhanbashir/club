                            ...
                            <form name="club_page" id="club_page" action="<?php echo base_url(); ?>index.php/admin/page/update" method="POST"  enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label>Detailed description of Snooker room</label>
                                    ...
                                    <a href="<?php echo site_url('admin/snookernews/addnew'); ?>" id=""><i class="glyphicon glyphicon-plus"></i> Add News</a>
                                                ...
                                                <div class="box box-primary" style="min-height: 130px;">
                                                    <div class="box-header with-border">
                                                        ...
                                                        <div class="box-tools pull-right">
                                                            <a href="<?php echo base_url('index.php/admin/snookernews/edit/' . $news['content_id']); ?>">Edit</a> | 
                                                            <a href="<?php echo base_url('index.php/admin/snookernews/delete/' . $news['content_id']); ?>">Delete</a>
                                                        </div>
                                                    </div><!-- /.box-header -->
                                                    <div class="box-body">
