                            ...
                            <form name="club_page" id="club_page" action="<?php echo base_url(); ?>index.php/admin/page/update" method="POST"  enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label>Detailed description of library</label>
                                    ...
                                    <div class="form-group">
                                        <label>Library rules & regulation</label>
                                        <textarea class="form-control" name="page[data][rulesandregulation]" id="page_description" placeholder="Enter ..."><?php echo!empty($data['rulesandregulation']) ? $data['rulesandregulation'] : ''; ?></textarea>
                                    </div>
                                    <div class="form-group">
