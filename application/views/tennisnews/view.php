...
<section class="content">
    <div class="row  col-xs-12">
        <div class="col-xs-6">
            ...
            <p class="lead col-xs-6">News # <?php echo ucfirst($tennisnew['content_id']); ?></p>


            <a href="<?php echo site_url('admin/tennisnews/delete/' . $tennisnew['content_id']) ?>"><button class="btn btn-danger pull-right delete_anything" style="margin:10px ">Delete</button></a>
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $tennisnew['description']; ?></td>
                        </tr>
