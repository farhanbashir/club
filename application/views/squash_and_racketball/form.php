...
<section class="content">
    ...
    <div class="row">
        <div class="col-xs-12">
            <p class="lead">Squash and Racketball</p>
            <div class="col-xs-12">
                <div class="col-xs-9">
                        ...
                        <div class="box box-primary">
                            ...
                            <form name="club_page" id="club_page" action="<?php echo base_url(); ?>index.php/admin/page/update" method="POST"  enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                    ...
                                    <?php
                                    if (!empty($page['squash_and_racketballnews'])) {
                                        foreach ($page['squash_and_racketballnews'] as $news) {
                                            ?>
                                            ...
                                            <div class="box box-primary" style="min-height: 130px;">
                                                <div class="box-header with-border">
                                                    ...
                                                    <div class="box-tools pull-right">
                                                        <a href="<?php echo base_url('index.php/admin/squash_and_racketballnews/edit/'.$news['content_id']);?>">Edit</a> | 
                                                        <a href="<?php echo base_url('index.php/admin/squash_and_racketballnews/delete/'.$news['content_id']);?>">Delete</a>
                                                    </div>
                                                </div><!-- /.box-header -->
                                                <div class="box-body">
