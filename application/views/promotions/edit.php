                                            ...
                                            <div class="jFiler-item-inner">                                    
                                                ...
                                                <div class="jFiler-item-assets jFiler-row">         
                                                    ...
                                                    <ul class="list-inline pull-right">   
                                                        <li><a href="<?php echo base_url(); ?>index.php/admin/promotions/delete_image/<?php echo $image['id'] . '/' . $promotion['content_id']; ?>" class="icon-jfi-trash jFiler-item-trash-action"></a>
                                                        </li>                                       
                                                    </ul>                                
                                                </div>
