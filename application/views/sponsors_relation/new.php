        ...
        <div class="col-xs-6">
            ...
            <div class="table-responsive">
                ...
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <form name="add_sponsor" id="club_sponsor_page" action="<?php echo base_url(); ?>index.php/admin/sponsors_relation/submit" method="POST"  enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" class="form-control" name="sponsor_relation[title]" placeholder="Enter ...">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="sponsor_sponsors" name="sponsor_relation[sponsor]">
                                    ...
                                    foreach ($sponsor_relation['sponsor'] as $sponsor) {
                                        ?>
                                        <option value="<?php echo $sponsor['content_id'] ?>"><?php echo $sponsor['title'] ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
