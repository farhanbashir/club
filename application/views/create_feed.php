                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <select id="from" name="from" class="form-control">
                                                <?php for($i=0;$i<36;$i++) { ?>
                                                <option <?php echo set_select('from', $i); ?> value="<?php echo $i;?>"><?php echo $i;?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select id="to" name="to" class="form-control">
                                                <?php for($i=0;$i<36;$i++) { ?>
                                                <option <?php echo set_select('to', $i); ?> value="<?php echo $i;?>"><?php echo $i;?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select id="milestone_id" name="milestone_id" class="form-control">
                                                ...
                                                <option <?php echo set_select('milestone_id', $milestone['milestone_id']); ?> value="<?php echo $milestone['milestone_id'];?>"><?php echo $milestone['milestone_name'];?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label for="end_date">Feed</label>
                                            <textarea class="form-control" id="feed" name="feed" rows="3" placeholder="Enter ..."><?php echo set_value('feed', ''); ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="end_date">Feed Arabic</label>
                                            <textarea class="form-control" id="feed_ar" name="feed_ar" rows="3" placeholder="Enter ..."><?php echo set_value('feed_ar', ''); ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="end_date">Intro</label>
                                            <textarea class="form-control" id="intro" name="intro" rows="3" placeholder="Enter ..."><?php echo set_value('intro', ''); ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="end_date">Intro Arabic</label>
                                            <textarea class="form-control" id="intro_ar" name="intro_ar" rows="3" placeholder="Enter ..."><?php echo set_value('intro_ar', ''); ?></textarea>
                                        </div>
                                    </div><!-- /.box-body -->
